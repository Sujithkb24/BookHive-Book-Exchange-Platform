...
const AuthForm = () => {
  ...
  const API_BASE_URL = 'http://localhost:3000/api/auth'; // Change this to your actual backend URL
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (data.success) {
        // Store token (Note: localStorage not available in Claude artifacts)
        // localStorage.setItem('token', data.token);
        setMessage({ text: 'Login successful! Token received.', type: 'success' });
    ...
    <div className="min-h-screen bg-transparent flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8  ">
        <div className="w-full max-w-md">
          ...
          {/* Message Display */}
          {message.text && (
            <div className={`mb-6 ml-10 p-4 rounded-xl flex items-center gap-3 backdrop-blur-sm ${
...
>
  <div className="w-full h-full bg-transparent flex items-center justify-center relative overflow-hidden">
    ...
    <div className="z-20 text-center mt-10 px-2 -ml-9">
      <p className='text-black px-28  text-4xl font-bold'>Explore wide range of books in and around you</p>
      <img
        src="login1.png"
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 17.25v1.007a3 3 0 0 1-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0 1 15 18.257V17.25m6-12V15a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 15V5.25m18 0A2.25 2.25 0 0 0 18.75 3H5.25A2.25 2.25 0 0 0 3 5.25m18 0V12a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 12V5.25" />
          ...
          <span className="text-gray-700 font-medium mt-2">Login</span>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 1 0-7.5 0v4.5m11.356-1.993 1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 0 1-1.12-1.243l1.264-12A1.125 1.125 0 0 1 5.513 7.5h12.974c.576 0 1.059.435 1.119 1.007ZM8.625 10.5a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm7.5 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
          ...
          <span className="text-gray-700 font-medium mt-2">Buy / Sell</span>
        </div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 8.25H9m6 3H9m3 6-3-3h1.5a3 3 0 1 0 0-6M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
          ...
          <span className="text-gray-700 font-medium mt-2">Earn Coins</span>
        </div>
      </div>
    </div>
        ...
        <div className={`absolute inset-0 transition-all duration-700 ease-in-out ${
          ...
          <div className="w-full h-full bg-gradient-to-br from-emerald-500 via-teal-600 to-cyan-700 flex items-center justify-center relative">
            {/* Decorative Elements */}
            <div className="absolute top-16 right-16 w-28 h-28 bg-white/10 rounded-full blur-xl"></div>
            <div className="absolute bottom-24 left-16 w-36 h-36 bg-emerald-400/20 rounded-full blur-2xl"></div>
            <div className="absolute top-1/3 right-1/3 w-20 h-20 bg-teal-400/15 rounded-full blur-lg"></div>
            
            {/* Content */}
            <div className="text-center z-20 px-12">
              ...
              <p className="text-xl text-white/80 leading-relaxed">
                Begin your adventure today and unlock endless possibilities with your new account.
              </p>
